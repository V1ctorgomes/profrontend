export const cardEffects =
  'card-glow transition-all duration-300 hover:-translate-y-0.5 hover:border-brand-200 hover:shadow-md';

export const boxEffects =
...
export const btnPrimaryClass =
  'inline-flex h-10 items-center justify-center gap-2 rounded-lg bg-brand-900 px-4 text-sm font-medium text-white transition-all duration-200 hover:-translate-y-px hover:bg-brand-700 hover:shadow-md active:translate-y-0 focus:outline-none focus:ring-2 focus:ring-brand-900 focus:ring-offset-2 disabled:pointer-events-none disabled:opacity-60';

export const btnSecondaryClass =
  'inline-flex h-10 items-center justify-center gap-2 rounded-lg border border-slate-200 bg-white px-4 text-sm font-medium text-brand-900 transition-all duration-200 hover:-translate-y-px hover:border-slate-300 hover:bg-slate-50 hover:shadow-sm active:translate-y-0 disabled:pointer-events-none disabled:opacity-60';
...
export const tabButtonInactiveClass =
  'rounded-lg bg-white px-4 py-2 text-sm font-medium text-slate-600 ring-1 ring-slate-200 transition-all duration-200 hover:-translate-y-px hover:bg-slate-50 hover:shadow-sm';
